        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-slate-300 mb-4">
              Discover the world with our expertly curated travel experiences, crafted to create memories that last a lifetime.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-slate-300 hover:text-teal-400 transition-colors">Destinations</a>
              </li>
              <li>
                <a href="#" className="text-slate-300 hover:text-teal-400 transition-colors">Packages</a>
              </li>
              <li>
                <a href="#" className="text-slate-300 hover:text-teal-400 transition-colors">Travel Blog</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-slate-300">123 Travel Lane, Adventure City, AC 12345</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">info@wanderlust-travels.com</span>
              </li>
            </ul>
          </div>
        </div>
